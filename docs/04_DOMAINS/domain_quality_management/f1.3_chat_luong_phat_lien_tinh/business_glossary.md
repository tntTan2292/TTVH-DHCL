...
- **BCVH**: Bưu cục Văn hóa - Đơn vị chịu trách nhiệm phát cấp xã/phường.
...
- **Nộp tiền muộn**: Một trong các nguyên nhân (Root Cause) khiến Bưu gửi rớt F1.3, xảy ra khi `Thời gian nộp tiền - Thời gian PTC > 2 giờ`.
