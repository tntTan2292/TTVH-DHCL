...
| `docs/10_TICKETS/AUTO-BACKFILL-UI-REMEDIATION_MANIFEST.md` | Ticket Manifest | Active ticket AUTO-BACKFILL-UI-REMEDIATION (Phase B frontend, `IMPLEMENTED / READY FOR PO UI CHECK`, 2026-08-19, baseline `29346c92`, executor Antigravity): No-code Operator UI for 6 canonical coverage statuses, smart monthly grouping accordions, real PO exception confirmation/revocation modals (`PO_EXEMPTED`), slide-out audit drawers, and VNPost Light Dashboard tokens. | L2 | Current Required Reading | Current ticket only. | Mandatory |
| `docs/06_REVIEWS/Import/AUTO-BACKFILL-UI-REMEDIATION_CHECKPOINT_001.md` | Checkpoint | Current checkpoint for AUTO-BACKFILL-UI-REMEDIATION: activation record, implementation ledger, and frontend verification suite. | L2 | Current Required Reading | Current ticket only. | Mandatory |
...
| `docs/10_TICKETS/AUTO-BACKFILL-COVERAGE-EXCEPTION_MANIFEST.md` | Ticket Manifest | Active ticket AUTO-BACKFILL-COVERAGE-EXCEPTION (Phase A backend, `ACTIVATED / IMPLEMENTATION IN PROGRESS`, 2026-08-19, baseline `3fce810f`, executor Claude Code): PO-approved 6-state coverage model, controlled Legacy Baseline Reconciliation, 5-point-proof `VERIFIED_NO_DATA`, reasoned/audited/reversible `PO_EXEMPTED`. | L2 | Current Required Reading | Current ticket only. | Mandatory |
