...
| `docs/10_TICKETS/AUTO-IMPORT-002_MANIFEST.md` | Reviews | Verified manifest for Automated Download and Validation Pipeline awaiting PO commit approval | Active | L2 | 1 | High | README_AI.md, PROJECT_SNAPSHOT.md, AUTO-IMPORT-001 handoff |
| `docs/06_REVIEWS/Import/AUTO-IMPORT-002_HUE_F13_ACQUISITION_ENGINE.md` | Reviews | AUTO-IMPORT-002 Hue F1.3 acquisition engine architecture, API, live verification, cleanup evidence, tests, and limitations | Active | L2 | 1 | High | AUTO-IMPORT-002 manifest, import pipeline, import watcher |
