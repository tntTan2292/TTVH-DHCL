...
- Current ticket (`2026-08-20`): `AUTO-BACKFILL-RUNTIME`, `ACTIVATED / READY FOR PO CHECK`, baseline `a135f799`. Product Owner separately authorized Runtime readiness; no automatic real run is authorized by this readiness state.
- Current manifest: `docs/10_TICKETS/AUTO-BACKFILL-RUNTIME_MANIFEST.md`.
