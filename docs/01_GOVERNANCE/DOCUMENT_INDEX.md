...
| `docs/10_TICKETS/DA-IMPL-003_MANIFEST.md` | Reviews | Active manifest for Integrated Trend and Risk Workspace | Active | L2 | 1 | High | README_AI.md, PROJECT_SNAPSHOT.md, smart Dashboard plan, DA register |
