...
| `docs/10_TICKETS/TICKET-0101_MANIFEST.md` | Reviews | Current ticket manifest for TICKET-0101 Login API and Session | Active | L2 | 1 | High | README_AI.md, PROJECT_SNAPSHOT.md, backlog, feature, epic, auth implementation files |
| `docs/06_REVIEWS/Auth/TICKET-0101_LOGIN_API_AND_SESSION.md` | Reviews | TICKET-0101 login API and session implementation/runtime evidence | Active | L2 | 1 | High | PO acceptance workflow, manifest, checklist |
| `docs/06_REVIEWS/Auth/TICKET-0101_PO_ACCEPTANCE_CHECKLIST.md` | Reviews | TICKET-0101 PO acceptance checklist for login and session behavior | Active | L2 | 1 | High | PO acceptance workflow, manifest, review evidence |
