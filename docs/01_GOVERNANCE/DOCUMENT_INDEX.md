...
| `docs/10_TICKETS/F13-BCVH-DAILY-SAMEWEEKDAY-01_MANIFEST.md` | Ticket Manifest (new) | PO-authorized amendment adding a 10th column "Tăng/giảm so với cùng kỳ (tuần trước)" to the closed F13-BCVH-MONTHLY-CUMULATIVE-01 9-column table; embedded Design of Record, implementation, and test evidence (Claude Code, Sonnet 5). | L2 | `IMPLEMENTED / TECH PASS / READY FOR PO UI CHECK` | Side ticket, separate from Current Ticket. | Reference |
