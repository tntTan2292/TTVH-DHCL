...
| `docs/10_TICKETS/F13-ROUTE-RANKING-REDESIGN-PLAN_MANIFEST.md` | Ticket Manifest | Current F1.3 Route Ranking redesign discovery/planning ticket; delta-only implementation inventory and Product Owner open questions, no implementation authority. | L2 | Active Onboarding | Current planning ticket only. | Mandatory |
