...
- `docs/03_UX/bcvh/BCVH_PERFORMANCE_CENTER_UX_ARCHITECTURE.md`
...
- `docs/03_UX/route/ROUTE_PERFORMANCE_CENTER_UX_ARCHITECTURE.md`
...
- `docs/03_UX/evidence/EVIDENCE_CENTER_UX_ARCHITECTURE.md`
...
- `docs/03_UX/action/ACTION_CENTER_UX_ARCHITECTURE.md`
- `docs/06_REVIEWS/Shared/UX_CONSISTENCY_REVIEW.md`
- `docs/06_REVIEWS/Shared/ARCHITECTURE_CONSISTENCY_REVIEW.md`
...
6. `docs/02_ARCHITECTURE/QIS_V2_ARCHITECTURE.md`
...
For a fresh session, start by reading this file, then `PROJECT_STATUS.md`, then `PROJECT_PROGRESS.md`.
