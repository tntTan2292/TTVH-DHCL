...
### 1. Điều kiện phát hiện
- Tỷ lệ chậm nộp tiền tăng cao.

### 2. Thông tin hiển thị
- Màn hình RCA, Tab Chậm nộp tiền: Hiển thị Tỷ lệ chậm nộp tiền.

### 3. Hướng điều hành đề xuất
- Nhắc nhở bưu tá thực hiện nộp tiền đúng quy định (≤ 3 giờ sau khi PTC).
- *Hướng hành động cụ thể: TODO - Waiting Product Owner.*
