...
Only `DA-IMPL-003` is active. AUTO-IMPORT and later DA-IMPL tickets remain planned and inactive until the prior ticket receives `PO PASS` or explicit governance authority allows parallel work.
...
| 3 | `DA-IMPL-003` Integrated Trend and Risk Workspace | `ACTIVE` | `NOT READY` | [docs/10_TICKETS/DA-IMPL-003_MANIFEST.md](https://github.com/tntTan2292/TTVH-DHCL/blob/main/docs/10_TICKETS/DA-IMPL-003_MANIFEST.md) |
