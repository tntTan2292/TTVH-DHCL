...
- F13-SHARED-NAV-FILTERS-IMPL: `ACTIVE / IMPLEMENTATION COMPLETED / READY FOR PO UI REVIEW` (2026-08-03). Authorized under PO PLAN PASS. Parameter dual-read compatibility (`bcvh_id || ma_bcvh`), Route Ranking title update ("Bảng xếp hạng Tuyến Bưu tá"), dynamic BCVH metadata loading, and GlobalFilterBar prop cleanup implemented without modifying existing tables, formulas, or permissions.
