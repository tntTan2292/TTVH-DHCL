  ...
  return (
    <div className="mb-6 bg-blue-50 border border-blue-100 rounded-xl p-5 shadow-sm">
      ...
      <div className="text-sm text-gray-800 leading-relaxed space-y-2">
        <p>
          <span className="font-semibold text-vnpost-blue">• Tình trạng:</span> Toàn mạng hiện <strong>{statusStr}</strong> ({kpiVal}%), <strong>{trendStr} {Math.abs(kpiDod)}%</strong> so với hôm qua. Xếp hạng toàn quốc đứng thứ <strong>{rank}</strong> ({rankTrendStr}).
        </p>
        <p>
