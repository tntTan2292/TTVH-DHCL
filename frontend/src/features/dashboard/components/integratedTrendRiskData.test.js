...
test('trendline request preserves aggregate and canonical BCVH context while keeping chart-safe windows', () => {
  assert.deepEqual(
    ...
    { from_date: '2026-07-02', to_date: '2026-07-15' },
  );
  assert.deepEqual(
    ...
    { from_date: '2026-07-02', to_date: '2026-07-15', ma_bcvh: '533140' },
  );
});
